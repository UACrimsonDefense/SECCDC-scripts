...
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditLogonEvents" -Value 3 -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditAccountLogon" -Value 3 -ErrorAction SilentlyContinue

# Enable auditing of account management events
Write-Host "Enabling auditing of account management events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditAccountManage" -Value 3 -ErrorAction SilentlyContinue

# Enable auditing of directory service access events
Write-Host "Enabling auditing of directory service access events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\NTDS\Diagnostics' -Name "16 Directory Service Access" -Value 2 -ErrorAction SilentlyContinue

# Enable auditing of object access events
Write-Host "Enabling auditing of object access events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Object Access" -Value 3 -ErrorAction SilentlyContinue

# Enable auditing of detailed tracking events
Write-Host "Enabling auditing of detailed tracking events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditDetailedTracking" -Value 3 -ErrorAction SilentlyContinue

# Enable auditing of kernel object events
Write-Host "Enabling auditing of kernel object events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditKernelObject" -Value 3 -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\NTDS\Parameters' -Name "DSA Heuristics" -Value 0000001000000000 -ErrorAction SilentlyContinue

# Enable auditing of changes to registry keys
Write-Host "Enabling auditing of changes to registry keys..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\SecurePipeServers\Winreg\AllowedExactPaths' -Name "Machine" -Value "@" -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditPolicyChange" -Value 3 -ErrorAction SilentlyContinue
...
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Security System Extension" -Value 3 -ErrorAction SilentlyContinue

#Enable auditing of changes to audit policies
Write-Host "Enabling auditing of changes to audit policies..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Audit Policy Change" -Value 3 -ErrorAction SilentlyContinue

#Enable auditing of changes to user rights assignments
Write-Host "Enabling auditing of changes to user rights assignments..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Security State Change" -Value 3 -ErrorAction SilentlyContinue

#Enable auditing of privilege use events
Write-Host "Enabling auditing of privilege use events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Control\Lsa' -Name "AuditPrivilegeUse" -Value 3 -ErrorAction SilentlyContinue

#Enable auditing of process tracking events
Write-Host "Enabling auditing of process tracking events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Process Creation" -Value 3 -ErrorAction SilentlyContinue
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Process Termination" -Value 3 -ErrorAction SilentlyContinue
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Detailed File Share" -Value 3 -ErrorAction SilentlyContinue

#Enable auditing of system integrity events
Write-Host "Enabling auditing of system integrity events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Audit System Integrity" -Value 3 -ErrorAction SilentlyContinue

#Enable auditing of firewall events
Write-Host "Enabling auditing of firewall events..."
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\eventlog\Security' -Name "Audit Firewall Rule Changes" -Value 3 -ErrorAction SilentlyContinue

Write-Host "Enabling Firewall logging successful and blocked connections..."
Set-NetFirewallProfile -Profile Domain,Public,Private -LogAllowed True -LogBlocked True

#--------------------------------------------------------------------------------------
# FROM APPLIED enableAuditing.ps1

# Enable auditing of SAM and security system extension events
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\EventLog\Security' -Name "AuditSAM" -Value 3
Set-ItemProperty -Path 'HKLM:\System\CurrentControlSet\Services\EventLog\Security' -Name "AuditSecuritySystemExtension" -Value 3

#-------------------------------------------------------------------------------------
# FROM CPP-CYBER Log.ps1
